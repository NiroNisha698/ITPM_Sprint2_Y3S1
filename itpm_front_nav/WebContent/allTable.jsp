...
<div class= table style="width: 80%; margin: auto; padding: 20px;background-color: #6a92ff; box-shadow: 300px 104px 208px 0 rgba(0.2, 0.2, 0.2, 0.2), 0 116px 120px 0 rgba(0.5, 0.5, 0.5, 0.19); " >
	
	<div class=heading style="width:90%; margin: auto; padding:20px;  background-color: #d991a4;">

 <h3 class="kt-portlet__head-title kt-font-brand;" style="text-align:center;">Program Complexity </h3>
  </div>
 <br>
  <table style="width: 100%">
    ...
    <tbody>
        <tr>
            <td style="background-color: #777; align:center">Line no</td>
            <td style="background-color: #aaa; text-align:center">Program Statement</td>
            <td style="background-color: #777">Cs</td>
            <td style="background-color: #777">Cv</td>
            <td style="background-color: #777">Cm</td>
            <td style="background-color: #777">Ci</td>
            <td style="background-color: #777">Ccp</td>
            <td style="background-color: #777">Ccs</td>
            <td style="background-color: #777">TCps</td>
