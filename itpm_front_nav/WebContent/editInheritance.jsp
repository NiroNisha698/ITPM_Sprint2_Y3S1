...
<button class="btn-left" style="color: #0C5645;
background: #cf5b83; height:30px; width:120px;cursor: pointer;
  border-radius: 4px;
  border-bottom: 4px solid #117A60;
  transition: all .2s ease; font-size:20px;" onclick="window.location.href = 'inheritance.jsp';">Back</a></button>
...
<form action="inheritance.jsp" class="form" method="POST" style="font-family: century gothic;">
...
<br>
  <table style="width: 100%">
    ...
    <tbody>
        <tr>
            <td style="background-color: #777; align:center">Inherited Pattern</td>
            <td style="background-color: #aaa; text-align:center">Weight</td>
</tr>
...
<br>
<button style="width:150px;  margin:auto;" type="submit"  class="btn btn-primary btn-lg">Save</button>
</form>
</body>
</html>